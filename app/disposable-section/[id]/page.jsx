...
export default function DisposableProductDetailPage({ params }) {
  ...
  if (!product || product.sectionSlug !== 'disposable-section') {
    notFound();
  }

  const relatedProducts = getRelatedProducts(productId, 'disposable-section', 4);
      ...
      <div className="bg-white border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center gap-2 text-sm text-gray-600">
            ...
            <span>›</span>
            <Link href="/disposable-section" className="hover:text-blue-600 transition-colors">
              Disposable Section
            </Link>
            <span>›</span>
