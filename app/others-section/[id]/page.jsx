...
export default function OthersProductDetailPage({ params }) {
  ...
  if (!product || product.sectionSlug !== 'others-section') {
    notFound();
  }

  const relatedProducts = getRelatedProducts(productId, 'others-section', 4);
      ...
      <div className="bg-white border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center gap-2 text-sm text-gray-600">
            ...
            <span>›</span>
            <Link href="/others-section" className="hover:text-blue-600 transition-colors">
              Others Section
            </Link>
            <span>›</span>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-6">
                {relatedProducts.map((relatedProduct) => (
                  <Link
                    ...
                    href={`/others-section/${relatedProduct.id}`}
                    className="group"
                  >
