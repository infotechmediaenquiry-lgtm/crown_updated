...
export default function OthersSectionPage() {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-6">
          <div className="flex items-center gap-2 text-sm text-gray-600">
            ...
            <span>›</span>
            <span className="text-gray-900 font-medium">Others Section</span>
          </div>
        </div>

        {/* Page Header */}
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-2">Others Section</h1>
          <p className="text-gray-600">
            Explore our diverse range of medical accessories and equipment
          </p>
